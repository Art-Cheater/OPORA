...
class Project(ActiveRecordMixin, BaseModel):
    ...
    cable_meters: Mapped[Decimal | None] = mapped_column(Numeric(12, 2), nullable=True)
    ...
    cable_meters_fact: Mapped[Decimal | None] = mapped_column(Numeric(12, 2), nullable=True)
