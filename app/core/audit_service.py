...
HTTP_ENDPOINT_META: dict[str, tuple[str, str, str]] = {
    ...
    "requests.link_defect": (AuditAction.UPDATE.value, EntityType.REQUEST.value, "Связь заявки с дефектом"),
    "requests.unlink_defect": (AuditAction.UPDATE.value, EntityType.REQUEST.value, "Снятие связи заявки с дефектом"),
    ...
    "defects.link_request": (AuditAction.UPDATE.value, EntityType.DEFECT.value, "Связь дефекта с заявкой"),
    "defects.unlink_request": (AuditAction.UPDATE.value, EntityType.DEFECT.value, "Снятие связи дефекта с заявкой"),
