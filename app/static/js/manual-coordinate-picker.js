...
(() => {
  ...
  function init(form) {
    ...
    form.querySelector("[data-coordinate-clear]")?.addEventListener("click", () => { f.lat.value = ""; f.lng.value = ""; if (f.source) f.source.value = ""; if (f.warning) f.warning.textContent = "Точка очищена."; });
