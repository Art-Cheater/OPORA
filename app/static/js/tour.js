...
(() => {
  ...
  const SECTIONS = [
    ...
    },
    {
      ...
      route: "/requests/?tab=defects",
      roleTips: {
        dispatcher: "Фиксируете неисправности даже без заявки.",
        master: "Берёте дефект в работу и добавляете в план на день.",
    ...
    },
    {
      ...
      route: "/work-orders/",
      roleTips: {
        dispatcher: "Смотрите карту заявок и дефектов. План мастера не назначаете.",
        master: "Собираете план на день: карта, ближайшие работы, порядок и маршрут.",
        executor: "Видите карту и план выезда.",
      },
      steps: [
        {
          target: "page-header",
          title: "Рабочее место мастера",
          text: "Главный вход — «Работа по заявкам». Здесь собирается план на день, а не отдельный список путевых листов.",
        },
        {
          target: "workbench",
          title: "Карта работ",
          text: "Красные точки — дефекты, синие — заявки. Нажмите маркер или кнопку «Добавить» в списке — работа попадёт в план.",
        },
        {
          target: "available-works",
          title: "Доступные работы",
          text: "Отсюда выбирайте заявки и дефекты. Переключатель Все / Заявки / Дефекты меняет список и карту.",
        },
        {
          target: "plan",
          title: "План на день",
          text: "Единый список заявок и дефектов. Можно менять порядок перетаскиванием и построить маршрут.",
          optional: true,
        },
      ],
    },
