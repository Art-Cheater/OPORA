...
(() => {
  ...
  const SECTIONS = [
    ...
    },
    {
      ...
      route: "/work-orders/",
      roleTips: {
        dispatcher: "Рабочее место: очередь заявок, карточка справа, действие «Выполнено».",
        master: "Открывайте заявку из списка и отмечайте выполнение.",
        executor: "Смотрите очередь и карточку выбранной заявки.",
      },
      steps: [
        {
          target: "workbench",
          title: "Рабочее место",
          text: "Это не журнал. Слева — очередь заявок, справа — карточка выбранной заявки.",
        },
        {
          target: "filters",
          title: "Поиск и фильтры",
          text: "Найдите заявку по номеру или адресу. Фильтры: Все, Новые, В работе, Выполненные.",
        },
      ],
    },
    {
