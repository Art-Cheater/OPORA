      ...
      steps: [
        {
          target: "workbench",
          title: "Рабочее место",
          text: "Слева — очередь заявок и дефектов. Справа — карточка и связанные работы по ПП. Карты нет.",
        },
        {
          target: "filters",
          title: "Поиск и фильтры",
          text: "Журнал и статус — независимые фильтры. «Мои планы» и «Создать план работ» — рабочий контур мастера.",
        },
      ],
    },
    {
