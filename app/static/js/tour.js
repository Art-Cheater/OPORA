      ...
      steps: [
        {
          target: "workbench",
          title: "Рабочее место",
          text: "Слева очередь, справа карточка. Новый план открывается отдельной страницей.",
        },
        {
          target: "filters",
          title: "Поиск и фильтры",
          text: "Журнал и статус — независимые фильтры. «Мои планы» и «+ Новый план работ» открывают отдельный контур мастера.",
        },
      ],
    },
    {
