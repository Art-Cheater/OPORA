...
(() => {
  ...
  const SECTIONS = [
    ...
    },
    {
      ...
      route: "/work-orders/",
      roleTips: {
        dispatcher: "Очередь слева, карточка справа. Журналы, статусы и планы работ мастера.",
        master: "Собирайте план работ, берите связанные заявки по ПП и отмечайте выполнение.",
        executor: "Смотрите очередь и карточку выбранной работы.",
      },
      steps: [
        {
          target: "workbench",
          title: "Рабочее место",
          text: "Карта слева, доступные работы справа. Фильтры ПП, район и тип работают без перезагрузки.",
        },
        {
          target: "filters",
          title: "Поиск и фильтры",
          text: "Номер ПП, район и тип работы. «Поиск» обновляет список сразу. Добавление в план не требует F5.",
        },
      ],
    },
    {
