(() => {
  ...
  const paginationContainer = document.getElementById("projectsPaginationContainer");
  const resetBtn = document.getElementById("projectFilterReset");
  let currentPage = 1;
  ...
  async function loadTable() {
    ...
    const url = `/projects/table?${params.toString()}`;
  ...
  function bindPagination() {
    paginationContainer.querySelectorAll(".project-page-link").forEach((link) => {
