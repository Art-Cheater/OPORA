...
ALLOWED_TRANSITIONS: dict[str, frozenset[str]] = {
    STATUS_NEW: frozenset({STATUS_COMPLETED, STATUS_CANCELLED}),
    STATUS_EMERGENCY_DISPATCHED: frozenset({STATUS_COMPLETED, STATUS_CANCELLED}),
    STATUS_ACCEPTED_BY_MASTER: frozenset({STATUS_COMPLETED, STATUS_CANCELLED}),
