...
class Config:
    ...
    DEVICE_STATE_CONFIRM_TIMEOUT_SECONDS = int(os.getenv("DEVICE_STATE_CONFIRM_TIMEOUT_SECONDS", "10"))
    ...
    IRZ_MAP_DISPLAY_REFRESH_SECONDS = int(os.getenv("IRZ_MAP_DISPLAY_REFRESH_SECONDS", "20"))
    IRZ_CRITICAL_AFTER_SECONDS = int(os.getenv("IRZ_CRITICAL_AFTER_SECONDS", "3600"))
    ...
    GEOCODING_SUGGEST_TIMEOUT_SECONDS = float(
        os.getenv("GEOCODING_SUGGEST_TIMEOUT_SECONDS", "2.5")
    )
    ...
    NEARBY_ROUTING_CANDIDATE_LIMIT = int(os.getenv("NEARBY_ROUTING_CANDIDATE_LIMIT", "20"))
    ...
    EIS_YEAR_FROM = int(os.getenv("EIS_YEAR_FROM", "2025"))
