...
> **LEGACY / OUTDATED:** этот файл является историческим снимком и больше не
> описывает текущий HEAD полностью. Актуальная архитектурная документация:
> [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md). Практические правила для
> AI-агентов: [`AGENTS.md`](AGENTS.md).
