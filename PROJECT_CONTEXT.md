...
> **ВНИМАНИЕ:** этот файл устарел и сохранён только для исторического контекста.
> Он больше не описывает текущий HEAD полностью.
>
> Актуальная документация: [`AGENTS.md`](AGENTS.md) и
